...
.. glossary::
   ...
   программное обеспечение
     1. Все или часть программ, процедур, правил и соответствующей документации 
   ...
   Cascading Style Sheets
     ...
     использованием языка разметки. Подробнее см. http://docs.nextgis.ru/docs_ngweb/source/webmaps_client.html
     
   EPSG
   IOGP’s EPSG Geodetic Parameter Dataset
      Коллекция описаний систем координат и координатных преобразований, которые 
      могут быть глобальными , региональными, еациональными или локальными.
