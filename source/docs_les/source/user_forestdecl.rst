...
|
|  **5**.	Внесение данных о декларации в модуле «Лесная декларация» в NextGIS Лес и экспорт этих данных в виде файла JSON. `Подробнее <https://docs.nextgis.ru/docs_les/source/user_decl.html#id1>`_.
|
