...
При наведении курсора на кнопку в правом нижнем углу экрана становится доступно сохранение приложения в базу данных Приложений №3 (зеленая иконка) или экспорт его на компьютер пользователя в виде png-файла, упакованного в zip-архив (синяя иконка).
