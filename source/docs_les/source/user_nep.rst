...
При переходе в режим создания НЭП сначала открывается страница с перечнем всех имеющихся лесосек. Необходимо отметить галочкой ту лесосеку, в пределах которой будет создаваться неэксплуатационная площадь.
...
В остальном режимы работы виджета "НЭП" аналогичны рассмотренным ранее для виджета "Лесосеки".
