...
html_theme_options = {
    ...
    "header_dropdown_text": _("Sections"),
...
latex_documents = [
    (master_doc, "NextGIS.tex", "Документация NextGIS", "NextGIS", "manual", "true"),
]
...
man_pages = [(master_doc, "nextgis", "Документация NextGIS", [author], 1)]
