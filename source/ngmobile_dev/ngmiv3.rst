...
* Библиотека `nextgis_datastore<https://github.com/nextgis/nextgis_datastore>`
* Библиотека `ios_maplib<https://github.com/nextgis/ios_maplib>`

Библиотека **nextgis_datastore** написана на `С++11` и основана на `GDAL<http://gdal.org/>`. Она обеспечивает следующие возможности:
...
Для использования SDK необходимо :program:`Xcode 8` или выше. Также необходимо установить `Carthage` - легковесный менеджер зависимостей для `Swift` и `Objective-C`. Для установки Carthage следуйте инструкциям на `следующей странице<https://github.com/Carthage/Carthage/>`. 
...
Подробнее см. документацию `Carthage<https://github.com/Carthage/Carthage/>`.
