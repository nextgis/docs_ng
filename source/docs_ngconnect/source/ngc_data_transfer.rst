...
В случае, если изменения, внесенные в облаке, были ошибочными, и их нужно заменить на локальные, воспользуйтесь функцией обновления данных, описанной ниже.
...
Справочник из NextGIS Web в QGIS
------------------------------------------------

В Веб ГИС вы можете создавать `справочники <https://docs.nextgis.ru/docs_ngcom/source/lookup.html#ngcom-lookup-table-for-layer>`_. При экспорте слоя из Веб ГИС в QGIS значения справочника будут добавлены в слой как карта значений (value map).
